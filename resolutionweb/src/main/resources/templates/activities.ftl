...
<div class="container">
    <div class="row">
        <div class="col-3">
            <h3> Añadir Actividades </h3>
            <hr>
            <form role="form" action="/add" method="post">
                <div class="form-group">
                    <label for="nameActividad">Nombre de Actividad</label>
                    <input type="text" class="form-control" id="nameActividad" name="name" required/>
                </div>
                <div class="form-group">
            ...
            <hr>
               ...
               <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                   <div class="card-body d-flex flex-column align-items-start">
                       <img src="/img/actividad.jpg" class="card-img-left" style="float:left" alt="resultado" width="200" height="200">
                       <div class="mb-2 text-primary position-relative clearfix" style="float:right;">${item.name}</div>
                       ...
                       <p class="card-text mb-auto float-right clearfix">Código ID: ${item.id}</p>
                       <h3>${item.precio}€</h3>
