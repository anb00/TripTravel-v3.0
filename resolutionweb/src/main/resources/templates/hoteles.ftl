...
<div class="container">
    <div class="row">
        ...
        <div class="col-9" style="background-color: #f5f6f7;">
            <h3> Resultados </h3>
            <hr>
            ...
            <#if item??>
                <#list item as item>
                  <!--  <div  style="margin-top: 0px;">
                    <div class="row" style="box-shadow: 1px 1px 1px rgba(.03,.02,.01,.05);margin-top: -5px;margin: 1px;">
                            <div class="col-md-4" style="margin-top: 0px;">
                                <img src="img/Hilton.jpg" class="w-100" style="width: 450px;height: 250px;">
                            </div>
                            <div class="col-md-8 px-3"  style="margin-top: 0px;">
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <div class="img-square-wrapper">
                                <img class="" src="img/Hilton.jpg" alt="Card image cap" style="width: 300px;height: 250px;">
                            </div>
                            <div class="card-body">
